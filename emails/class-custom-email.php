...
//        add_action( 'woocommerce_order_status_processing_to_pending_notification', array( $this, 'trigger' ) );
        add_action( 'custom_processing_email_notification', array( $this, 'queue_notification' ) );
